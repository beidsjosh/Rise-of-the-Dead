...
public class RangedEnemyFSM : MonoBehaviour
{
    ...
    public float moveSpeed = 9.0f; // Speed of the enemy
    public float moveMultiply = 11.0f; //faster moveSpeed for attack
    ...
    void Start()
    {
        ...
        waypointList = GameObject.FindGameObjectsWithTag("RangedPatrolPoint");
