...
public class NinjaFSM : MonoBehaviour
{
    ...
    public float moveSpeed = 15.6f; // Speed of the enemy
    ...
    void Start()
    {
        ...
        waypointList = GameObject.FindGameObjectsWithTag("NinjaPatrolPoint");
    ...
    protected void UpdateDeadState()
    {
        ...
        if (!bDead)
        {
            ...
            playerTransform.gameObject.SendMessage("UpdateScore", (int) 150 );
        }
    }
